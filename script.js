...
let questions = [
  new Question("Vous êtes en entretien d'embauche et suite à un changement de poste votre manager vous convoque et vous demande comment se sont passés vos débuts. <br> Vous lui répondez que :", ["Au début c'était stressant et vous aviez du mal à vous adapter.", "Vous avez mis un peu de temps à vous adapter dû à la gestion de votre stress.", "Vous avez apprécié, cela vous a permis d'apprendre à gérer votre stress."], "Vous avez apprécié, cela vous a permis d'apprendre à gérer votre stress.", "<u>Explications :</u> Lors d'un entretien d'embauche il faut savoir valoriser vos points faibles en favorisant le gain d'expérience potentiel."),
  new Question("Un désaccord éclate entre vous et votre collègue :", ["Vous manquez de patience et lui hurlez dessus.", "Vous attendez que les tensions s’apaisent et vous vous expliquez plus tard.", "Vous faites l’impasse sur cette histoire et passez tout de suite à autre chose."], "Vous attendez que les tensions s’apaisent et vous vous expliquez plus tard.", "<u>Explications :</u> Il ne faut jamais laisser les problèmes en suspens, il faut les traiter rapidement mais faites le lorsque que tout le monde aura repris ses esprits."),
  ...
  new Question("Corentin et Thomas se sont disputés il y a 2 semaines.<br> Ils sont tous les 2 designers et la deadline pour la création du visuel de votre projet est déjà dépassée depuis 1 semaine.<br> En tant que team leader, que décidez-vous de faire ?", ["Vous les laissez gérer leurs conflits, vous n'en faites pas partie.", "Vous imposez votre autorité sans chercher à comprendre les raisons de la discorde.", "Vous organisez des réunions individuelles et communes en leur rappelant que l'équipe a besoin d'eux."], "Vous organisez des réunions individuelles et communes en leur rappelant que l'équipe a besoin d'eux.", "<u>Explications :</u> Il ne faut pas oublier que l'équipe prend du retard dû au manque de communication. Cependant si des tensions sont présentes il faut savoir écouter les raisons de chacun pour favoriser le bien-être de tous."),
